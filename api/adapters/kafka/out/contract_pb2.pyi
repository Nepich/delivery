...
class BasketConfirmedIntegrationEvent(_message.Message):
    ...
    def __init__(self, basketId: _Optional[str] = ..., address: _Optional[_Union[Address, _Mapping]] = ..., items: _Optional[_Iterable[_Union[Item, _Mapping]]] = ..., deliveryPeriod: _Optional[_Union[DeliveryPeriod, _Mapping]] = ...) -> None: ...
...
class Address(_message.Message):
    ...
    house: str
    apartment: str
    def __init__(self, country: _Optional[str] = ..., city: _Optional[str] = ..., street: _Optional[str] = ..., house: _Optional[str] = ..., apartment: _Optional[str] = ...) -> None: ...
...
class Item(_message.Message):
    ...
    price: float
    quantity: int
    def __init__(self, id: _Optional[str] = ..., goodId: _Optional[str] = ..., title: _Optional[str] = ..., price: _Optional[float] = ..., quantity: _Optional[int] = ...) -> None: ...
