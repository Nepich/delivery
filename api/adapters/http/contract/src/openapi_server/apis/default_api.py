...
from api.adapters.http.contract.src.openapi_server.models.extra_models import TokenModel  # noqa: F401
...
async def create_order(
    ...
    return await BaseDefaultApi.subclasses[0]().create_order()
...
async def get_couriers(
    ...
    if not BaseDefaultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDefaultApi.subclasses[0]().get_couriers()
...
async def get_orders(
    ...
    if not BaseDefaultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDefaultApi.subclasses[0]().get_orders()
